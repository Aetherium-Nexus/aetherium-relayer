...
use aetherium_core::{
    unwrap_or_none_result, AetheriumLogStore, AetheriumSequenceAwareIndexerStoreReader, Indexed,
    InterchainGasPayment, LogMeta, H512,
};

use crate::db::StorablePayment;
use crate::store::storage::AetheriumDbStore;

#[async_trait]
impl AetheriumLogStore<InterchainGasPayment> for AetheriumDbStore {
...
#[async_trait]
impl AetheriumSequenceAwareIndexerStoreReader<InterchainGasPayment> for AetheriumDbStore {
