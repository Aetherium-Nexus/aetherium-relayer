...
use aetherium_core::{
    unwrap_or_none_result, Delivery, AetheriumLogStore, AetheriumSequenceAwareIndexerStoreReader,
...
#[async_trait]
impl AetheriumLogStore<Delivery> for AetheriumDbStore {
...
#[async_trait]
impl AetheriumSequenceAwareIndexerStoreReader<Delivery> for AetheriumDbStore {
