...
use aetherium_base::settings::IndexSettings;
use aetherium_core::{
    BlockId, BlockInfo, AetheriumDomain, AetheriumLogStore, AetheriumProvider,
    AetheriumWatermarkedLogStore, LogMeta, H256, H512,
};
...
#[async_trait]
impl<T> AetheriumWatermarkedLogStore<T> for AetheriumDbStore
where
    AetheriumDbStore: AetheriumLogStore<T>,
{
