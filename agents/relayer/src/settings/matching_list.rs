...
use derive_new::new;
use aetherium_core::{
    config::StrOrInt, utils::hex_or_base58_to_h256, AetheriumMessage, QueueOperation, H256,
};
use serde::{
...
impl<'a> From<&'a AetheriumMessage> for MatchInfo<'a> {
    fn from(msg: &'a AetheriumMessage) -> Self {
        Self {
            src_msg_id: msg.id(),
...
impl MatchingList {
    ...
    pub fn msg_matches(&self, msg: &AetheriumMessage, default: bool) -> bool {
...
mod test {
    ...
    fn supports_sequence_h256s() {
        ...
        let value_parser =
            aetherium_base::settings::parser::ValueParser::new(Default::default(), &val);
