...
use aetherium_base::{settings::CheckpointSyncerBuildError, MultisigCheckpointSyncer};
use aetherium_core::{
    accumulator::merkle::Proof, AggregationIsm, CcipReadIsm, Checkpoint, AetheriumDomain,
    AetheriumMessage, InterchainSecurityModule, MultisigIsm, RoutingIsm, H256,
};
...
pub struct MockBaseMetadataBuilderResponses {
    pub origin_domain: Option<AetheriumDomain>,
    pub destination_domain: Option<AetheriumDomain>,
