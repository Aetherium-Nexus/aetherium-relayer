...
use eyre::Result;
use aetherium_base::db::AetheriumRocksDB;
use aetherium_core::{
    FixedPointNumber, GasPaymentKey, AetheriumMessage, InterchainGasExpenditure,
...
impl GasPaymentEnforcer {
    ...
    pub fn record_tx_outcome(&self, message: &AetheriumMessage, outcome: TxOutcome) -> Result<()> {
...
mod test {
    ...
    use aetherium_base::db::{test_utils, AetheriumRocksDB};
    use aetherium_core::{
        AetheriumDomain, AetheriumMessage, InterchainGasPayment, LogMeta, TxCostEstimate, H160,
        H256, U256,
    };
    ...
    async fn test_empty_whitelist() {
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_empty_whitelist"),
                db,
            );
    ...
    async fn test_no_match() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db =
                AetheriumRocksDB::new(&AetheriumDomain::new_test_domain("test_no_match"), db);
    ...
    async fn test_different_destinations() {
        #[allow(unused_must_use)]
        test_utils::run_test_db(|db| async move {
            let msg = AetheriumMessage {
                destination: 123,
                ..AetheriumMessage::default()
            };

            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_different_destinations"),
                db,
            );
            let enforcer = GasPaymentEnforcer::new(
                vec![GasPaymentEnforcementConf {
            ...
            aetherium_db.process_gas_payment(wrong_destination_payment, &LogMeta::random());
            ...
            aetherium_db.process_gas_payment(correct_destination_payment, &LogMeta::random());
    ...
    async fn test_half_and_half_payment() {
        ...
        test_utils::run_test_db(|db| async move {
            ...
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_half_and_half_payment"),
                db,
            );
            ...
            aetherium_db.process_gas_payment(initial_payment, &LogMeta::random());
            ...
            aetherium_db.process_gas_payment(deficit_payment, &LogMeta::random());
    ...
    async fn test_non_empty_matching_list() {
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(&AetheriumDomain::new_test_domain("test_non_empty_matching_list"), db);
            ...
            let matching_message = AetheriumMessage {
                sender,
                recipient,
                ..AetheriumMessage::default()
            };
            ...
            let not_matching_message = AetheriumMessage {
                sender: recipient,
                recipient: sender,
                ..AetheriumMessage::default()
            };
    ...
    async fn test_no_payment_found_minimum_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_no_payment_found_minimum_policy"),
                db,
            );
    ...
    async fn test_deminimis_payment_found_minimum_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_deminimis_payment_found_minimum_policy"),
                db,
            );

            let payment = InterchainGasPayment {
                message_id: AetheriumMessage::default().id(),
                destination: AetheriumMessage::default().destination,
                payment: U256::from(1),
                gas_amount: U256::from(1),
            };
            aetherium_db.process_gas_payment(payment, &LogMeta::random());
    ...
    async fn test_zero_payment_found_minimum_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_zero_payment_found_miniumn_policy"),
                db,
            );
    ...
    async fn test_no_payment_found_none_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_no_payment_found_none_policy"),
                db,
            );
    ...
    async fn test_payment_found_none_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_payment_found_none_policy"),
                db,
            );
    ...
    async fn test_no_payment_found_quote_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_no_payment_found_quote_policy"),
                db,
            );
    ...
    async fn test_payment_found_quote_policy() {
        ...
        test_utils::run_test_db(|db| async move {
            let aetherium_db = AetheriumRocksDB::new(
                &AetheriumDomain::new_test_domain("test_payment_found_quote_policy"),
                db,
            );
