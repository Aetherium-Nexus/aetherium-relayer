...
use aetherium_core::{AetheriumMessage, InterchainSecurityModule, Mailbox, ModuleType, H256};
...
impl AppContextClassifier {
    ...
    pub async fn get_app_context(&self, message: &AetheriumMessage) -> Result<Option<String>> {
