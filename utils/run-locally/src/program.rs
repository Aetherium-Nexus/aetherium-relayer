...
impl Program {
    ...
    /// add an env that will be prefixed with the default aetherium env prefix
    pub fn aet_env(self, key: impl AsRef<str>, value: impl Into<String>) -> Self {
        const PREFIX: &str = "AET_";
        let key = key.as_ref();
        debug_assert!(
