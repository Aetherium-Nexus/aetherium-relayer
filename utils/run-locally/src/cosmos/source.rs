...
use super::{CW_AETHERIUM_GIT, CW_AETHERIUM_VERSION, OSMOSIS_CLI_GIT, OSMOSIS_CLI_VERSION};
...
impl Default for CodeSource {
    fn default() -> Self {
        Self::remote(CW_AETHERIUM_GIT, CW_AETHERIUM_VERSION)
    }
}
