...
pub fn relayer_termination_invariants_met(
    ...
    const AET_INCOMING_BODY_LOG_MESSAGE: &str = "incoming body completed";
    ...
    let aet_incoming_body_line_filter = vec![AET_INCOMING_BODY_LOG_MESSAGE];
    ...
    let invariant_logs = vec![
        ...
        aet_incoming_body_line_filter.clone(),
    ...
    assert!(
        !log_counts.contains_key(&aet_incoming_body_line_filter),
...
pub fn scraper_termination_invariants_met(
    ...
    let dispatched_messages_scraped = fetch_metric(
        ...
        "aetherium_contract_sync_stored_events",
...
pub fn provider_metrics_invariant_met(
    ...
    let request_count = fetch_metric(relayer_port, "aetherium_request_count", filter_hashmap)?
        .iter()
        .sum::<u32>();
    ...
    let provider_create_count = fetch_metric(
        relayer_port,
        "aetherium_provider_create_count",
