...
use aetherium_core::{AetheriumDomain, H160};
use aetherium_metric::prometheus_metric::PrometheusClientMetrics;
...
impl CoreMetrics {
    ...
    ///
    /// The value of
    /// `aetherium_last_known_message_nonce{phase=message_processed}`
    ...
    pub fn get_latest_checkpoint_validator_delta(&self, origin_chain: AetheriumDomain) -> i64 {
