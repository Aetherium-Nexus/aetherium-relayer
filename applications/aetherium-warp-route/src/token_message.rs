//! The Aetherium Token message format.

use aetherium_core::{Decode, Encode, AetheriumProtocolError, H256, U256};

/// Message contents sent or received by a Aetherium Token program to indicate
