//! This crate contains core primitives, traits, and types for Aetherium
//! implementations.
...
pub use chain::*;
pub use error::*;
pub use error::{ChainCommunicationError, ChainResult, AetheriumProtocolError};
pub use identifiers::AetheriumIdentifier;
pub use traits::*;
pub use types::*;
...
/// Core aetherium system data structures
mod types;
