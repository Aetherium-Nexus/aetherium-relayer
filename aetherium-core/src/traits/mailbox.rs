...
use crate::{
    ...
    AetheriumContract, AetheriumMessage, QueueOperation, ReorgPeriod, TxCostEstimate, H256, U256,
};

/// Interface for the Mailbox chain contract. Allows abstraction over different
/// chains
#[async_trait]
pub trait Mailbox: AetheriumContract + Send + Sync + Debug {
    ...
    async fn process_batch(
        &self,
        _messages: &[BatchItem<AetheriumMessage>],
