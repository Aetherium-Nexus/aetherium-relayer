...
use crate::{BlockInfo, ChainInfo, ChainResult, AetheriumChain, TxnInfo, H256, H512, U256};
...
#[async_trait]
#[auto_impl(&, Box, Arc)]
pub trait AetheriumProvider: AetheriumChain + Send + Sync + Debug {
...
#[derive(Error, Debug)]
pub enum AetheriumProviderError {
