...
use crate::{AetheriumMessage, InterchainGasPayment, MerkleTreeInsertion, Sequenced, H256};
...
impl From<AetheriumMessage> for Indexed<AetheriumMessage> {
    fn from(value: AetheriumMessage) -> Self {
