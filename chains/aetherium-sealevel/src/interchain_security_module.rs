...
use aetherium_core::{
    ...
    AetheriumDomain, AetheriumMessage, InterchainSecurityModule, ModuleType, H256, U256,
};
use aetherium_sealevel_interchain_security_module_interface::InterchainSecurityModuleInstruction;
...
impl AetheriumContract for SealevelInterchainSecurityModule {
    fn address(&self) -> H256 {
        self.program_id.to_bytes().into()
    }
}

impl AetheriumChain for SealevelInterchainSecurityModule {
