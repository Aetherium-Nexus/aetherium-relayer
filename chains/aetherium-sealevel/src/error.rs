use aetherium_core::{ChainCommunicationError, H512};
use solana_client::client_error::ClientError;
use solana_sdk::pubkey::ParsePubkeyError;
use solana_transaction_status::{EncodedTransaction, UiMessage};

/// Errors from the crates specific to the aetherium-sealevel
/// implementation.
/// This error can then be converted into the broader error type
/// in aetherium-core using the `From` trait impl
#[derive(Debug, thiserror::Error)]
pub enum AetheriumSealevelError {
...
impl From<AetheriumSealevelError> for ChainCommunicationError {
    fn from(value: AetheriumSealevelError) -> Self {
