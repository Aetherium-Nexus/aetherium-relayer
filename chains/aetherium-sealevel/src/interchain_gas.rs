...
use aetherium_core::{
    ...
    AetheriumChain, AetheriumContract, AetheriumDomain, AetheriumProvider, Indexed, Indexer,
...
impl AetheriumContract for SealevelInterchainGasPaymaster {
    fn address(&self) -> H256 {
        self.program_id.to_bytes().into()
    }
}

impl AetheriumChain for SealevelInterchainGasPaymaster {
...
impl SealevelInterchainGasPaymasterIndexer {
    ...
    async fn get_payment_with_sequence(
        ...
        let discriminator = aetherium_sealevel_igp::accounts::GAS_PAYMENT_DISCRIMINATOR;
...
fn test_unique_gas_payment_pubkey_offset() {
    ...
    use aetherium_sealevel_igp::accounts::GasPaymentData;
