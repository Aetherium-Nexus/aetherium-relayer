...
use aetherium_core::{
    utils::bytes_to_hex, ChainCommunicationError, ChainResult, AetheriumDomain, ReorgPeriod, H256,
    U256,
};
...
pub fn apply_gas_estimate_buffer(gas: U256, domain: &AetheriumDomain) -> ChainResult<U256> {
