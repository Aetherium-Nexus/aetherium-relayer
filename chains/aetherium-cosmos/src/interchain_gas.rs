...
use aetherium_core::{
    ...
    AetheriumDomain, AetheriumProvider, Indexed, Indexer, InterchainGasPaymaster,
...
use crate::{ConnectionConf, CosmosProvider, AetheriumCosmosError};
...
impl AetheriumContract for CosmosInterchainGasPaymaster {
    fn address(&self) -> H256 {
        self.address
    }
}

impl AetheriumChain for CosmosInterchainGasPaymaster {
...
mod tests {
    ...
    use aetherium_core::{InterchainGasPayment, H256, U256};
