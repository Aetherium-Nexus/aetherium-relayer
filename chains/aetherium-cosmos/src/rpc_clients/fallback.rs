...
/// Wrapper of `FallbackProvider` for use in `aetherium-cosmos`
#[derive(new, Clone)]
...
mod tests {
    ...
    use aetherium_core::rpc_clients::test::ProviderMock;
    use aetherium_core::rpc_clients::{BlockNumberGetter, FallbackProviderBuilder};
