...
use aetherium_core::{
    utils::bytes_to_hex, ChainResult, ContractLocator, AetheriumChain, AetheriumContract,
    AetheriumDomain, AetheriumMessage, AetheriumProvider, Mailbox, RawAetheriumMessage,
...
impl AetheriumContract for CosmosMailbox {
    fn address(&self) -> H256 {
        self.address
    }
}

impl AetheriumChain for CosmosMailbox {
