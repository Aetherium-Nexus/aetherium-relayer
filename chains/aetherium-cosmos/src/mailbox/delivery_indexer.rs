...
use aetherium_core::{
    ChainCommunicationError, ChainResult, ContractLocator, Delivery, AetheriumMessage, Indexed,
...
use crate::{ConnectionConf, AetheriumCosmosError, Signer};
...
impl Indexer<H256> for CosmosMailboxDeliveryIndexer {
    async fn fetch_logs_in_range(
        ...
        let logs_futures = parse_logs_in_range(
            range,
            self.provider.clone(),
            Self::aetherium_delivery_parser,
            "DeliveryCursor",
        );
