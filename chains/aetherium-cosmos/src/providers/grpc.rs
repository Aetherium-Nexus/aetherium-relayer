...
use aetherium_core::{
    ...
    ChainCommunicationError, ChainResult, ContractLocator, FixedPointNumber, AetheriumDomain, U256,
};

use crate::{
    prometheus::metrics_channel::MetricsChannel, rpc_clients::CosmosFallbackProvider,
    AetheriumCosmosError,
};
...
pub struct WasmGrpcProvider {
    /// Aetherium domain, used for special cases depending on the chain.
