...
use aetherium_core::{
    ChainCommunicationError, ChainResult, Checkpoint, ContractLocator, AetheriumChain,
    AetheriumContract, AetheriumDomain, AetheriumProvider, Indexed, Indexer, LogMeta,
...
use crate::{ConnectionConf, CosmosProvider, AetheriumCosmosError, Signer};
...
impl AetheriumContract for CosmosMerkleTreeHook {
    fn address(&self) -> H256 {
        self.address
    }
}

impl AetheriumChain for CosmosMerkleTreeHook {
